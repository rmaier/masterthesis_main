...
SCHWARZ et al. entwickelt ein Reifegradmodell zur Bewertung des Implementierungsfortschritts von Lean Production im Unternehmen. Einfache Befragungen eignen sich aufgrund der Komplexität nicht zur Bewertung. 
...
\Gls{bspw} wird abgefragt, inwieweit die 5 Lean Prinzipien in der Unternehmensphilosophie verankert, kommuniziert und verstanden ist (``Annahme und Überzeugung'') oder indwieweit die Implementierung von den Führungskräftenn unterstützt wird (``Werte''). 
