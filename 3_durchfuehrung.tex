...
Die Gestaltungsfelder (s. Abb. \ref{fig:dom11a:gf}) beschreiben ``Wie'' die Dinge getan werden sollen. Sie bilden einen thematischen Rahmen für inhaltlich ähnlicht Methoden und Werkzeuge, die die Teilziele unterstützen. Methoden sind planmäßige Vorgehensweisen wie z.B. der Problemlöseprozess, der mit dem Werzeug \gls{fmea} % TODO cite [4]?! 
...
\subsection{Die Gestaltungsfelder im Lean Ramp-up}
