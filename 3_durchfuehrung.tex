...
% \end{figure}
\begin{description}
\item[Schwerpunkte für First-Mover:] Der Fokus des First-Mover liegt in der Zieldimension Zeit. 
% 	IMAGE REF
...
% 	FOLLOWER - KOSTEN
\item[Schwerpunkte für Follower (Kosten):] Der Fokus des Follower (Kosten) liegt in der Zieldimension Kosten. 
% 	IMAGE REF
...
% 	FOLLOWER - QUALITÄT
\item[Schwerpunkte für Follower (Qualität):] Der Fokus des Follower (Qualität) liegt in der Zieldimension Qualität.
% 	IMAGE REF
...
\item[Schwerpunkte für Repeater:] Die Schwerpunkte für Repeater werden nicht gesondert erläutert, da sie abhängig von der gewählten Zieldimension den bereits vorgestellten Herangehensweisen entsprechen. 
% \subsubsection{Einordnung}
