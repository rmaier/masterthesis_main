...
ZANNER betont die Bedeutung der Vertrauensverhältnisses für den Informationsaustausch und schlägt informelle standortübergreifende Treffen der Entwickler vor \cite[42]{Zanner2002}. 
Weiterhin 

Schuh2008: 
Standardänderungsprozess s.219
verbesserte Zusammenarbeit zw. Herstellern unterschiedlicher Wertschöpfungsstufe
Zanner2002:
Schnittstellenmanagement


Enabler: 
präventive Maßnahmen  in der Änderungsplanung Schuh08
Durchgängiges Produkt-Versions-Management Kuhn
Verlagerung der krit. Freigabeprozesse auf die Komponentenebene Kuhn
Mindestreifegrade Kuhn
Standardisierte Dokumentation, vermeidung mehrfacher Informationswege und wechselnder Ansprechpartner Kuhn
Einheitliche Datebnasis Kuhn

Zanner2002: 
durchgängige verantwortlichkeit eines MA für die Koord. und Abwicklung des Änderungsfalls
